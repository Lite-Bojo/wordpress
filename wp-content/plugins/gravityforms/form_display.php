    ...
    public static function get_form($form_id, $display_title=true, $display_description=true, $force_display=false, $field_values=null, $ajax=false, $tabindex = 1){
        ...
        if(empty($confirmation_message)){
                ...
                <script type='text/javascript'>" . apply_filters("gform_cdata_open", "") . "" .
                    ...
                    "jQuery(window).load(function($){" .
                        ...
                        "jQuery('#gform_ajax_frame_{$form_id}').load( function(){" .
                            ...
                            "var is_redirect = jQuery(this).contents().text().indexOf('gformRedirect(){') >= 0;".
                            ...
                            "else if(!is_redirect){" .
                                ...
                                "if(!confirmation_content){".
                                    "confirmation_content = jQuery(this).contents().find('*').html();".
                                "}" .
                                "setTimeout(function(){" .
            ...
            if($start_at_zero && $has_pages && !IS_ADMIN && ($form["confirmation"]["type"] == "message" && $form["pagination"]["type"] == "percentage") && $form["pagination"]["display_progressbar_on_confirmation"])
            {
                ...
                if($ajax)
                {
                    $progress_confirmation = "<!DOCTYPE html><html><head><meta charset='UTF-8' /></head><body>" . $progress_confirmation . $confirmation_message . "</body></html>";
                }
                else
                {
            ...
            else
            {
                ...
                if($ajax)
                {
                    $progress_confirmation = "<!DOCTYPE html><html><head><meta charset='UTF-8' /></head><body>" . $confirmation_message . "</body></html>";
                }
                else
                {
