...
class GFCommon{
	...
	/* Wao zmena public function na public static function erory v plugine na preklady aka scripting guard*/
	...
	/*Wao zmena funcie na public static function kvoli erroru v Localization addone. Tvorca pouziva staru metodu volania funkcii namiesto -> pouziva :: a to musi byt public static*/
    ...
    public static function get_product_fields($form, $lead, $use_choice_text=false, $use_admin_label=false){
        ...
        $product_info = gform_get_meta($lead['id'], 'gform_product_info');
