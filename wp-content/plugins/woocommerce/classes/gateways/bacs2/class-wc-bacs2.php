 ...
 * @author 		WooThemes
 */
class WC_BACS2 extends WC_Payment_Gateway {
    ...
    public function __construct() {
		...
		$this->method_title     = __( 'Záloha', 'woocommerce' );
    	...
    	add_action('woocommerce_thankyou_bacs2', array(&$this, 'thankyou_page2'));
	...
	public function admin_options() {
    	?>
    	<h3><?php _e('Záloha', 'woocommerce'); ?></h3>
    ...
    function email_instructions( $order, $sent_to_admin ) {
    	...
    	if ( $order->payment_method !== 'bacs2') return;
 ...
 * @return array
 */
function add_bacs2_gateway( $methods ) {
	$methods[] = 'WC_BACS2';
	return $methods;
}

add_filter('woocommerce_payment_gateways', 'add_bacs2_gateway' );